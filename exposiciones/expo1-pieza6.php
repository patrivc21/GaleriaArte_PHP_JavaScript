    ...
    <body>
        ...
        <main class="expo1">
            <section class="piezas">
                <a href="../exposiciones/expo1.php">  <img src = "../imagenes/expo1/incendio-troya.jpeg" alt = "Foto 3"/> </a>
                <p><i>El incendio de Troya</i></p>
                <p><i>Primera mitad del siglo XVII. Óleo sobre lienzo, 140 x 238 cm</i></p>
                <p><i>CORTE, JUAN DE LA</i></p>
                <p>Como es sabido, La Guerra de Troya terminó con la introducción, por parte de los griegos, en la ciudad, de un 
                    caballo de madera lleno de soldados, quienes una vez llegada la noche la toman e incendian. En una escena 
                    nocturna y con escenografía teatral, el pintor ha situado a la izquierda, iluminándolo, el palacio. De él salen 
                    las figuras de Eneas, llevando a su padre Anquises sobre sus hombros, e inmediatamente detrás su esposa Creusa,
                     dando la mano al hijo de ambos, Ascanio. A la derecha de la composición se narra la lucha entre griegos y 
                     troyanos en un escenario de edificios en llamas, que sirven para iluminar el cuadro, y la silueta del famoso 
                     caballo, origen de la destrucción de la ciudad.</p>
            </section>
        </main>
