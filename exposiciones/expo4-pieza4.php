    ...
    <body>
        ...
        <main class="expo1">
            <section class="piezas">
                <a href="../exposiciones/expo4.php"> <img src = "../imagenes/expo4/diadumeno.jpg" alt = "Foto 6"/> </a>
                <p><i>Diadumeno</i></p>
                <p>El Diadúmeno o Diadumeno es una estatua diseñada por Policleto en el siglo V a. C. La estatua original fue realizada en metal, seguramente en bronce, pero en la actualidad sólo se conservan copias de piedra caliza y mármol.
                    Representa a un atleta griego ciñendo en su cabeza la cinta de la victoria, de donde procede el nombre διαδούμενος diadúmenos el que se ciñe, que deriva del término griego διαδέω diadéo ceñir. Aún está desnudo después de la competición y eleva los brazos para atarse la diadema, una banda en forma de cinta que identifica al ganador y que en la obra original de alrededor del año 420 a. C. estaría representada por una cinta labrada</p>
            </section>
        </main>
