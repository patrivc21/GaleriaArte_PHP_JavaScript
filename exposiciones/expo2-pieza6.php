    ...
    <body>
        ...
        <main class="expo1">
            <section class="piezas">
                <a href="../exposiciones/expo2.php"> <img src = "../imagenes/expo2/parasol.jpeg" alt = "Foto 2"/> </a>
                <p><i>El quitasol</i></p>
                <p><i>1777. Óleo sobre lienzo, 104 x 152 cm</i></p>
                <p><i>FRANCISCO DE GOYA</i></p>
                <p>Cartón para tapiz cuyo motivo principal es una elegante joven, a la que un majo protege del sol con una sombrilla o quitasol. Pudo tener como modelo una obra del pintor francés Jean Ranc, Vertumno y Pomona, ahora en el Musée Fabre, de Montpellier, aunque Goya transformó el asunto mitológico en una escena de la vida moderna.</p>
            </section>
        </main>
