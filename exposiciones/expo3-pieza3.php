    ...
    <body>
        ...
        <main class="expo1">
            <section class="piezas">
                <a href="../exposiciones/expo3.php"> <img src = "../imagenes/expo3/biblioteca.jpeg" alt = "Foto 3"/> </a>
                <p><i>Biblioteca Ivan de Vargas, Madrid de los Austrias 130</i></p>
                <p><i>Jose Javier Martin Espartosa</i></p>
                <p>La Biblioteca Pública Municipal “Iván de Vargas” fue inaugurada en febrero de 2011. Se encuentra situada en el corazón del Madrid de los Austrias y ocupa el espacio de un antiguo caserón perteneciente a uno de los linajes más antiguos de Madrid: los Vargas, siendo Iván de Vargas señor del patrón de la ciudad, San Isidro Labrador.</p>
            </section>
        </main>
