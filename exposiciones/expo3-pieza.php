    ...
    <body>
        ...
        <main class="expo1">
            <section class="piezas">
                <a href="../exposiciones/expo3.php"> <img src = "../imagenes/expo3/calle-nuñez.jpeg" alt = "Foto 1"/> </a>
                <p><i>Calle nuñez de arce/alvarez gato, Madrid de los Austrias 0469</i></p>
                <p><i>JOSE JAVIER MARTÍN ESPARTOSA</i></p>
                <p>La calle de Álvarez Gato o callejón del Gato, es una pequeña vía en el límite del Barrio de las Letras en Madrid, que une la calle de la Cruz con la de Núñez de Arce. En el siglo XVII aparece con el nombre de calle del Gato en el plano de Teixeira (1656), a espaldas del popular Corral de comedias de la Cruz.</p>
            </section>
        </main>
