    ...
    <body>
        ...
        <main class="expo1">
            <section class="piezas">
                <a href="../exposiciones/expo4.php"> <img src = "../imagenes/expo4/demeter.jpg" alt = "Foto 3"/> </a>
                <p><i>Demeter</i></p>
                <p><i>Primer cuarto del siglo III. Mármol blanco, 222,5 x 115 cm</i></p>
                <p>Réplica romana que reproduce una escultura de la diosa de la tierra cultivada. Estaba expuesta en el santuario de Eleusis, lugar famoso por sus ritos mistéricos durante toda la Antigüedad. El original fue realizado hacia el 420 a.C. por Agorácrito o Alcámenes, los principales discípulos de Fidias, recordando con sus pliegues y actitud las cariátides del Erecteo en la Acrópolis de Atenas. Cabeza y brazos son añadidos de la época barroca. Procede de la colección Odescalchi 184 de donde llegóa al Palacio de La Granja de San Ildefonso.</p>
            </section>
        </main>
