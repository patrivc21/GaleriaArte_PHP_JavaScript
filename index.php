...
<html lang = "en">
    <head>
        ...
        <meta name="application-name" content="P2 PW">
        ...
        <main>
            ...
            <section class="expos">
               ...
               <!-- <section class="articulo">
                    ...
                    <?php
                        require_once('exposiciones/exposicion.class.php');

                        $arrayE=array();
                        $exposiciones=Exposicion::obtenerExposiciones($arrayE);
                    ?>
                </section > -->

                <script language="javascript">
                    function mialerta() {
                        alert("Titulo exposicion: " + document.getElementById("titulo").innerHTML + " y tipo de exposicion: " + document.getElementById("tipo").innerHTML );
                    }

                    function mialerta2() {
                        alert("Titulo exposicion: " + document.getElementById("titulo2").innerHTML + " y tipo de exposicion: " + document.getElementById("tipo2").innerHTML );
                    }

                    function mialerta3() {
                        alert("Titulo exposicion: " + document.getElementById("titulo3").innerHTML + " y tipo de exposicion: " + document.getElementById("tipo3").innerHTML );
                    }

                    function mialerta4() {
                        alert("Titulo exposicion: " + document.getElementById("titulo4").innerHTML + " y tipo de exposicion: " + document.getElementById("tipo4").innerHTML );
                    }
                </script>

                <section class="articulo">
                    <a href="exposiciones/expo1.php" onMouseOver="mialerta()"> <img src = "imagenes/expo1/expo1-portada.jpeg" alt = "Foto exposicion 1"/> </a>
                    <p id="titulo">Arte y mito.</p>
                    <p><i>Autor:</i> Varios</p>
                ...
                <section  class="articulo">
                    <a href="exposiciones/expo2.php" onMouseOver="mialerta2()"> <img src = "imagenes/expo2/expo2-portada.jpeg" alt = "Foto exposicion 2"/> </a>
                    <p id="titulo2">Goya y su pintuta.</p>
                    <p><i>Autor:</i> Goya</p>
                    <p>Óleo sobre lienzo</p>
                    <p>1781</p>
                    <p id="tipo2">Pintura</p>
                </section >
                
                <section class="articulo">
                    <a href="exposiciones/expo3.php" onMouseOver="mialerta3()"> <img src = "imagenes/expo3/expo3-portada.jpeg" alt = "Expo3"/> </a>
                    <p id="titulo3">Madrid al descubierto.</p>
                    <p><i>Autor:</i> Jose Javier Martin Espartosa</p>
                    <p id="tipo3">Fotografia</p>
                </section >

                <section class="articulo">
                    <a href="exposiciones/expo4.php" onMouseOver="mialerta4()"> <img src = "imagenes/expo4/expo4-portada.jpeg" alt = "Foto de la exposicion 4"/> </a>
                    <p id="titulo4">Entre dioses y hombres.</p>
                    <p><i>Autor:</i> Varios</p>
                    <p id="tipo4">Escultura</p>
                </section >
